...
public class VerificationService {
    ...
    private static boolean passwordVerification(PasswordField password, Alert alert) {
    ...
    public static boolean fullVerification(TextField login, PasswordField password, PasswordField passwordConfirm, TextField name, Alert alert) {
        return nameVerification(name, alert) && loginVerification(login, alert) && passwordVerification(password, alert) && passwordConfirm(password, passwordConfirm, alert);
    }
}
